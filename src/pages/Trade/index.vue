  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(address, index) in addressInfo" :key="address.id">
        ...
        <p @click="clickDefault(address, addressInfo)">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="(tradeInfo, index) in tradeInfo.detailArrayList"
          :key="tradeInfo.skuId"
        >
          <li>
            <img :src="tradeInfo.imgUrl" alt style="width: 100px" />
          </li>
          <li>
            <p>{{ tradeInfo.skuName }}</p>
            <h4>7天无理由退货</h4>
          </li>
          <li>
            <h3>{{ tradeInfo.orderPrice }}</h3>
          </li>
...
export default {
  ...
  methods: {
    clickDefault(address, addressInfo) {
